...
source_compressed: ffmpeg -vf "crop=498:996:710:20,scale=-2:1920,pad=1080:1920:(ow-iw)/2:0:color=black" -c:v libx264 -crf 20 -preset slow -c:a copy -movflags +faststart (10.98 MB → 15.06 MB, crop content + scale + pad to 1080x1920 9:16 per RULES §3.1 + faststart)
