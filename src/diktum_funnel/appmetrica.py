"""AppMetrica Reporting API — установки Diktum по источникам.

Метрика ym:ts:installDevices (traffic sources namespace), разбивка по
ym:ts:publisher (Органика / VK Ads / …). TZ приложения — Europe/Moscow.
"""
